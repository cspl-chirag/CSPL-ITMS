...
import com.example.hp.superadminitms.Adapter.ReportPartReplacementDataAdapter;
...
public class Admin_PartReplacementReport extends BaseActivity implements ConnectivityReceiver.ConnectivityReceiverListener, View.OnClickListener {
    ...
    private ReportPartReplacementDataAdapter reportAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin__part_replacement_report);
        initializeToolBar();
        initializeControls();
    }
    ...
    private void initializeToolBar() {
        ...
        getSupportActionBar().setTitle("Buswise Part Replaced Details");
        ...
        switch (view.getId())
        {
            ...
            case R.id.ivStartDate:
                ...
                else
                {
                    ...
                    DatePickerDialog startDatePickerDialog = new DatePickerDialog(Admin_PartReplacementReport.this, new DatePickerDialog.OnDateSetListener() {
                        @Override
            ...
            case R.id.ivEndDate:
                ...
                else
                {
                    ...
                    mMonth = c.get(Calendar.MONTH);
                    mDay = c.get(Calendar.DAY_OF_MONTH);
                    DatePickerDialog endDatepickerDialog = new DatePickerDialog(Admin_PartReplacementReport.this, new DatePickerDialog.OnDateSetListener() {
                        @Override
                        public void onDateSet(DatePicker datePicke, int year, int monthOfYear, int dayOfMonth)
                        {
    ...
    private void getReportData() {
        ...
        pg.show();
        Call<ReportPartReplacementResponse> call = apiInterface.getPartReplacementReport(new ReportPartReplacementRequest(Company_Id, 0, Selected_Start_Date, Selected_End_Date));
        call.enqueue(new Callback<ReportPartReplacementResponse>() {
                ...
                try {
                    if (response.isSuccessful()) {
                        if (response.body().getStatusCode() == 1) {
                            ...
                            reportAdapter = new ReportPartReplacementDataAdapter(Admin_PartReplacementReport.this, reportData);
            ...
            public void onFailure(Call<ReportPartReplacementResponse> call, Throwable t) {
                ...
                AlertDialog.Builder builder =
                        new AlertDialog.Builder(Admin_PartReplacementReport.this);
