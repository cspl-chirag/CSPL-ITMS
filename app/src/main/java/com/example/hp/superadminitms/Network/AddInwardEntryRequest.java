...
public class AddInwardEntryRequest {
    ...
    public AddInwardEntryRequest(int user_ID, int company_ID, String bill_No, int part_ID, int store_ID, String manufacturer_Name, String inward_DTM, int quantity, double rate, int bill_Amount, String checked_By, String operator_Name, int courier_Agency_ID, String courier_LR_Number, String remark) {
        User_ID = user_ID;
