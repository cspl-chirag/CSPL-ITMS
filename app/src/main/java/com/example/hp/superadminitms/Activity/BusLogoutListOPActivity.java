...
public class BusLogoutListOPActivity extends BaseActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_logout_list);
        initializeToolBar();
        initViews();
    ...
    private void initializeToolBar() {
        ...
        getSupportActionBar().setTitle("Trip End");
    ...
    private void initViews() {
        ...
        rvLoggedOutBusList.setLayoutManager(new LinearLayoutManager(BusLogoutListOPActivity.this));
    }
    ...
    private void getLoggedOutBusList() {
        ...
        if (!isConnected) {
            AlertDialog.Builder builder =
                    new AlertDialog.Builder(BusLogoutListOPActivity.this);
                    ...
                    try {
                        if (response.isSuccessful()) {
                            if (response.body().getStatusCode() == 1) {
                                ...
                                loggedOutBusDataAdapter = new LoggedOutBusDataOPAdapter(loggedOutBusData, BusLogoutListOPActivity.this);

                                rvLoggedOutBusList.setAdapter(loggedOutBusDataAdapter);
                                loggedOutBusDataAdapter.notifyDataSetChanged();

                                loggedOutBusDataAdapter.SetOnItemClickListener(new LoggedOutBusDataOPAdapter.OnItemClickListener() {
                                    @Override
                                    public void onItemClick(View view, int position) {
                                        LoggedOutBusDatum loggedOutBusDatum = loggedOutBusData.get(position);
                                        Intent intent = new Intent(BusLogoutListOPActivity.this, UpdateBusLogoutOPActivity.class);
                                        intent.putExtra("LoggedOutBusData", loggedOutBusDatum);
