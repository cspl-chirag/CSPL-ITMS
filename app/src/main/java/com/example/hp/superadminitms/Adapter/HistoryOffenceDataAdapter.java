...
public class HistoryOffenceDataAdapter extends RecyclerView.Adapter<HistoryOffenceDataAdapter.ViewHolder> {
    private final Context context;
    private List<StaffWiseOffenceReport> reportList = new ArrayList<>();

    public HistoryOffenceDataAdapter(Context context, List<StaffWiseOffenceReport> reportList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.report_offence_history_data, parent, false));
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            tvStaffMemberName = itemView.findViewById(R.id.tvStaffMemberName);
        ...
        public void setData(int position, StaffWiseOffenceReport staffWiseOffenceReport) {
            ...
            tvStaffMemberName.setText(staffWiseOffenceReport.getStaffMemberName());
            try {
