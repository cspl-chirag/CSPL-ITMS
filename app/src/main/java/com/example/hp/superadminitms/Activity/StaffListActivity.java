...
import com.example.hp.superadminitms.Adapter.StaffMemberListAdapter;
...
public class StaffListActivity extends BaseActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    private StaffMemberListAdapter adapter;
            ...
            call.enqueue(new Callback<StaffListResponse>() {
                    ...
                    try {
                        if (response.isSuccessful()) {
                            if (response.body().getStatusCode() == 1) {
                                ...
                                adapter = new StaffMemberListAdapter(StaffListActivity.this, staffData);
                ...
                public void onFailure(Call<StaffListResponse> call, Throwable t) {
                    ...
                    AlertDialog.Builder builder =
                            new AlertDialog.Builder(StaffListActivity.this);
