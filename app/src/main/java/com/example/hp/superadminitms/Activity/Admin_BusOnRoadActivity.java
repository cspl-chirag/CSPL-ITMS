...
public class Admin_BusOnRoadActivity extends BaseActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin__bus_on_road);
        initializeToolBar();
        initViews();
    ...
    private void initializeToolBar() {
        ...
        getSupportActionBar().setTitle("Today On Road Buses");
    ...
    private void initViews() {
        ...
        rvLoggedInBusList.setLayoutManager(new LinearLayoutManager(Admin_BusOnRoadActivity.this));
    ...
    private void getLoggedInBusList() {
        ...
        if (!isConnected) {
            AlertDialog.Builder builder =
                    new AlertDialog.Builder(Admin_BusOnRoadActivity.this);
                    ...
                    try {
                        if (response.isSuccessful()) {
                            if (response.body().getStatusCode() == 1) {
                                ...
                                loggedInBusDataAdapter = new LoggedInBusDataOPAdapter(loggedInBusData, Admin_BusOnRoadActivity.this);
